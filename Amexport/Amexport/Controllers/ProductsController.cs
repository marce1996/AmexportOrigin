...
namespace Amexport.Controllers
{
    ...
    {
        private readonly IProductsService<Products> service;
        private readonly IMapper Mapper;

        public ProductsController(IProductsService<Products> service, IMapper mapper)
        {
        ...
        public async Task<JsonResult> ListAsync()
        {
            ...
            {
                dataQ = dataQ.Where(m => m.ProductName.IndexOf(searchValue.ToString(), StringComparison.OrdinalIgnoreCase) >= 0);
            }
